...
use Application\UserBundle\Form\Type\BrickType;
...
class BrickController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationSiteBundle:Brick')->findBy(
     ...
     * @Template("ApplicationUserBundle:Brick:edit.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationSiteBundle:Brick')->find($id);
